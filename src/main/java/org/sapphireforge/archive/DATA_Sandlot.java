...
public class DATA_Sandlot
{
    ...
    public static void ZDATAextract(RandomAccessFile inStream)throws IOException
    {
        ...
        //pure java
        try {
            FileInputStream fis = new FileInputStream(Main.infile);
            GZIPInputStream gis = new GZIPInputStream(fis);
            File fi = new File(Main.inputFull+".tmp");
        ...
        {
            System.out.println("Could not extract the file: "+Main.inputWithExtension);
        }
